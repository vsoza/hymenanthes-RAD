...
#open sample's clustering series stats file for reading from command line
...
#max number of alleles in Hymenanthes files is 15 so used 16 as length of j counter within each distance threshold
...
percent_clusters_1allele_file=open('/net/shendure/vol8/projects/Hymenanthes_RAD_Hall/clustering_threshold/transitive_clusters/Hym_percent_clusters_1allele.txt', 'a')
percent_clusters_2allele_file=open('/net/shendure/vol8/projects/Hymenanthes_RAD_Hall/clustering_threshold/transitive_clusters/Hym_percent_clusters_2allele.txt', 'a')
percent_clusters_3allele_file=open('/net/shendure/vol8/projects/Hymenanthes_RAD_Hall/clustering_threshold/transitive_clusters/Hym_percent_clusters_3allele.txt', 'a')
